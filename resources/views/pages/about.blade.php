...
<div class="container">
		...
		<div class="row">
			<div class="col-md-6">
                <p class="alert alert-warning">
                    <strong>
                        <i class="fa fa-warning"></i> This app has been built by 
                        <a target="_blank" href="http://twitter.com/etsmo">
                            @etsmo
                        </a> 
		...
		<p>Feel free to help to improve the <a target="_blank" href="https://github.com/Mermoz00/laracarte-tdn">source code</a>.</p>
